...
import src.loop167_phase_b.resource_guard_v7 as resource_guard_v7
...
from src.loop167_phase_b.windows_job_v7 import WindowsJobAssignmentProbeV7
...
def _ready_probe() -> WindowsJobAssignmentProbeV7:
...
def _resource_fixture(
    ...
    _write_json(
        root,
        RUNTIME_LOCK_RELATIVE_PATH,
        {"schema": "axon_loop167_phase_b_runtime_lock_v7", "loop_id": LOOP_ID},
    )
    bindings = {
    ...
    monkeypatch.setattr(resource_guard_v7, "verify_execution_contract_v7", verify_contract)
...
def _build_guard(
    ...
    *,
    ...
    return resource_guard_v7.build_resource_guard_payload_v7(
        root,
        ...
        snapshot=resource_guard_v7.SystemResourceSnapshotV7(
...
def _validate_guard(
    ...
    *,
    ...
    resource_guard_v7.validate_resource_guard_payload_v7(
        root,
        payload,
...
def test_v7_resource_guard_accepts_fresh_ready_twelve_gib_snapshot(
    ...
    verified = resource_guard_v7.verify_resource_guard_v7(
        root,
        guard_binding,
        expected_execution_contract_binding=bindings["execution_contract"],
        expected_source_closure_binding=bindings["source_closure"],
...
def test_v7_resource_guard_rejects_a_stale_snapshot(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with pytest.raises(PhaseBContractError, match="stale"):
        resource_guard_v7.verify_resource_guard_v7(
            root,
            guard_binding,
            expected_execution_contract_binding=bindings["execution_contract"],
            expected_source_closure_binding=bindings["source_closure"],
...
def test_v7_resource_guard_rejects_drifted_static_binding(
    ...
    _write_json(
        ...
        SOURCE_CLOSURE_RELATIVE_PATH,
        {
            "schema": "axon_loop167_phase_b_source_closure_v7",
            "loop_id": LOOP_ID,
            "drift": True,
        },
    )
