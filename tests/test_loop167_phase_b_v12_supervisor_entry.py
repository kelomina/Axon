...
SUPERVISOR_ENTRY_PATH = PROJECT_ROOT / "scripts" / "run_loop167_phase_b_supervisor_v12.py"
...
def test_v9_supervisor_entry_passes_sealed_relative_controller_argv(monkeypatch) -> None:
    ...
    monkeypatch.setattr(supervisor_entry, "create_fresh_launch_authorization_v12", lambda *_args, **_kwargs: fresh_launch)
    monkeypatch.setattr(
        supervisor_entry,
