...
import src.loop167_phase_b.resource_guard_v9 as resource_guard_v9
...
from src.loop167_phase_b.windows_job_v9 import WindowsJobAssignmentProbeV9
...
def _ready_probe() -> WindowsJobAssignmentProbeV9:
...
def _resource_fixture(
    ...
    _write_json(
        root,
        SOURCE_CLOSURE_RELATIVE_PATH,
        {"schema": "axon_loop167_phase_b_source_closure_v9", "loop_id": LOOP_ID},
    )
    _write_json(
        root,
        RUNTIME_LOCK_RELATIVE_PATH,
        {"schema": "axon_loop167_phase_b_runtime_lock_v9", "loop_id": LOOP_ID},
    )
    bindings = {
    ...
    monkeypatch.setattr(resource_guard_v9, "verify_execution_contract_v9", verify_contract)
...
def _build_guard(
    ...
    *,
    ...
    return resource_guard_v9.build_resource_guard_payload_v9(
        root,
        ...
        snapshot=resource_guard_v9.SystemResourceSnapshotV9(
...
def _validate_guard(
    ...
    *,
    ...
    resource_guard_v9.validate_resource_guard_payload_v9(
        root,
        payload,
...
def test_v9_resource_guard_accepts_fresh_ready_snapshot_without_memory_floor(
    ...
    verified = resource_guard_v9.verify_resource_guard_v9(
        root,
        guard_binding,
        expected_execution_contract_binding=bindings["execution_contract"],
        expected_source_closure_binding=bindings["source_closure"],
...
def test_v9_resource_guard_rejects_a_stale_snapshot(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with pytest.raises(PhaseBContractError, match="stale"):
        resource_guard_v9.verify_resource_guard_v9(
            root,
            guard_binding,
            expected_execution_contract_binding=bindings["execution_contract"],
            expected_source_closure_binding=bindings["source_closure"],
...
def test_v9_resource_guard_rejects_drifted_static_binding(
    ...
    _write_json(
        ...
        SOURCE_CLOSURE_RELATIVE_PATH,
        {
            "schema": "axon_loop167_phase_b_source_closure_v9",
            "loop_id": LOOP_ID,
            "drift": True,
        },
    )
