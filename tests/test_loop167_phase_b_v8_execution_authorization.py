...
from src.loop167_phase_b.resource_guard_v8 import RESOURCE_GUARD_SCHEMA
...
def _authorization_fixture(
    ...
    monkeypatch.setattr(execution_authorization_v8, "verify_execution_contract_v8", verify_contract)
    monkeypatch.setattr(execution_authorization_v8, "verify_resource_guard_v8", verify_guard)
    authorization_payload = execution_authorization_v8.build_execution_authorization_payload_v8(
        root,
...
def _validate_prelaunch(root: Path, context: dict[str, object]) -> object:
    return execution_authorization_v8.validate_execution_authorization_v8(
        root,
...
def test_v7_authorization_prelaunch_and_attested_child_surfaces(
    ...
    with pytest.raises(PhaseBContractError, match="attested child requires"):
        execution_authorization_v8.validate_execution_authorization_v8(
            root,
            context["authorization_path"],
            now_utc=NOW,
    ...
    monkeypatch.setattr(execution_authorization_v8, "validate_launch_receipt_v8", validate_launch)
    monkeypatch.setattr(execution_authorization_v8, "verify_child_job_attestation_v8", verify_attestation)
    verified = execution_authorization_v8.validate_execution_authorization_v8(
        root,
        context["authorization_path"],
        now_utc=NOW,
        phase="attested_child",
