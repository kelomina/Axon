#!/usr/bin/env python3
"""Run static preflight v2 for the future Loop167 Phase-B execution."""
...
from loop167_phase_b.preflight_v2 import validate_static_preflight_v2  # noqa: E402
...
def main() -> int:
    ...
    print(
        json.dumps(
            {
                "schema": "axon_loop167_phase_b_static_preflight_receipt_v2",
