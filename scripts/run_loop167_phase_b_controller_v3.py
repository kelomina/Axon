#!/usr/bin/env python3
"""Run static preflight v3 after pinning native-library threads in process."""
...
from loop167_phase_b.preflight_v3 import validate_static_preflight_v3  # noqa: E402
...
def main() -> int:
    ...
    print(
        json.dumps(
            {
                "schema": "axon_loop167_phase_b_static_preflight_receipt_v3",
