#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""739k cache 全量 content PE v1 特征提取。

输入：data/.cache/manifest_a807341e.json（738,983 样本，顺序即输出行序）
定位：按 basename==source_sha256（含 .exe/.dll/.sys/.bin 扩展）在原始树名字索引中找原始 PE。
提取：src/kvd_features/content_pe_v1.extract_content_pe_v1_features（pefile，100 维）。
输出（reports/full_739k/content_pe_v1/）：
...
OUT_DIR = PROJECT_ROOT / "reports" / "full_739k" / "content_pe_v1"
