#!/usr/bin/env python3
"""Build or verify the v3 lock for the self-bootstrapping isolated controller."""
...
RUNTIME_LOCK_PATH = ARTIFACT_ROOT / "phase_b_runtime_lock_v3.json"
...
def main() -> int:
    ...
    if args.write:
        ...
        if not RUNTIME_LOCK_PATH.is_file() or RUNTIME_LOCK_PATH.read_bytes() != expected:
            raise SystemExit("Phase-B runtime lock v3 is missing or drifted")
